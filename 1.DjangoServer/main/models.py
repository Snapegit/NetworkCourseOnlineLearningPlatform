...
class yonghu(BaseModel):
    ...
    yonghumima=models.CharField ( max_length=255,null=False, unique=False, verbose_name='用户密码' )
...
class yijifenlei(BaseModel):
    __doc__ = u'''yijifenlei'''
    __tablename__ = 'yijifenlei'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    yijifenlei=models.CharField ( max_length=255,null=False,unique=True, verbose_name='一级分类' )
    '''
    yijifenlei=VARCHAR
    '''
    class Meta:
...
class xuexiziyuan(BaseModel):
    ...
    ziyuanleixing=models.CharField ( max_length=255, null=True, unique=False, verbose_name='资源类型' )
    fengmian=models.TextField   (  null=True, unique=False, verbose_name='封面' )
    ziyuanneirong=models.TextField   (  null=True, unique=False, verbose_name='资源内容' )
    jianshu=models.TextField   (  null=True, unique=False, verbose_name='简述' )
...
class kechengxinxi(BaseModel):
    ...
    yijifenlei=models.CharField ( max_length=255,null=False, unique=False, verbose_name='一级分类' )
    erjifenlei=models.CharField ( max_length=255,null=False, unique=False, verbose_name='二级分类' )
    shipin=models.TextField   (  null=True, unique=False, verbose_name='视频' )
    jianshu=models.TextField   (  null=True, unique=False, verbose_name='简述' )
    xiangqingjieshao=models.TextField   (  null=True, unique=False, verbose_name='详情介绍' )
    clicktime=models.DateTimeField  (  null=True, unique=False, verbose_name='最近点击时间' )
    clicknum=models.IntegerField  (  null=True, unique=False, verbose_name='点击次数' )
...
class shequxinxi(BaseModel):
    __doc__ = u'''shequxinxi'''
    __tablename__ = 'shequxinxi'
    ...
    class Meta:
        db_table = 'shequxinxi'
        verbose_name = verbose_name_plural = '社区信息'
class kechengxuexi(BaseModel):
    __doc__ = u'''kechengxuexi'''
    __tablename__ = 'kechengxuexi'
    ...
    jianshu=models.TextField   (  null=True, unique=False, verbose_name='简述' )
    xuexishijian=models.FloatField   (  null=True, unique=False, verbose_name='学习时间' )
    yonghuzhanghao=models.CharField ( max_length=255, null=True, unique=False, verbose_name='用户账号' )
    yonghuxingming=models.CharField ( max_length=255, null=True, unique=False, verbose_name='用户姓名' )
    '''
    kechengmingcheng=VARCHAR
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '课程学习'
class kechengpaixing(BaseModel):
    __doc__ = u'''kechengpaixing'''
    __tablename__ = 'kechengpaixing'
    ...
    kechengfenlei=models.CharField ( max_length=255, null=True, unique=False, verbose_name='课程分类' )
    paiming=models.IntegerField  (  null=True, unique=False, verbose_name='排名' )
    tongjishijian=models.DateTimeField  (  null=True, unique=False, verbose_name='统计时间' )
    '''
    kechengmingcheng=VARCHAR
    tupian=Text
    kechengfenlei=VARCHAR
    paiming=Integer
    tongjishijian=DateTime
    '''
    class Meta:
        db_table = 'kechengpaixing'
        verbose_name = verbose_name_plural = '课程排行'
class ziyuanleixing(BaseModel):
    __doc__ = u'''ziyuanleixing'''
    __tablename__ = 'ziyuanleixing'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    ziyuanleixing=models.CharField ( max_length=255,null=False,unique=True, verbose_name='资源类型' )
    '''
    ziyuanleixing=VARCHAR
    '''
    class Meta:
        db_table = 'ziyuanleixing'
        verbose_name = verbose_name_plural = '资源类型'
class erjifenlei(BaseModel):
    __doc__ = u'''erjifenlei'''
    __tablename__ = 'erjifenlei'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    yijifenlei=models.CharField ( max_length=255, null=True, unique=False, verbose_name='一级分类' )
    erjifenlei=models.CharField ( max_length=255,null=False,unique=True, verbose_name='二级分类' )
    '''
    yijifenlei=VARCHAR
    erjifenlei=VARCHAR
    '''
...
class discussshequxinxi(BaseModel):
    __doc__ = u'''discussshequxinxi'''
    __tablename__ = 'discussshequxinxi'
    ...
    '''
    class Meta:
        db_table = 'discussshequxinxi'
        verbose_name = verbose_name_plural = '社区信息评论表'
