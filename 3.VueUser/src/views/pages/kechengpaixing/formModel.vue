	...
	<div class="app-contain" :style='{"padding":"10px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">排名</div>
					<div  class="info_text" >{{detail.paiming}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">统计时间</div>
					<div  class="info_text" >{{detail.tongjishijian}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('kechengpaixing','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('kechengpaixing','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
