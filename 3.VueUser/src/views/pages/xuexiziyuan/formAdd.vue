			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="资源内容" prop="ziyuanneirong">
						<editor class="list_editor" :value="form.ziyuanneirong" placeholder="请输入资源内容" :readonly="!isAdd||disabledForm.ziyuanneirong?true:false"
							@change="(e)=>editorChange(e,'ziyuanneirong')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.ziyuanneirong = res.data.data.ziyuanneirong.replace(reg,'../../../cl2604573/file');
