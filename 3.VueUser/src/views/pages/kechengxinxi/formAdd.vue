			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="详情介绍" prop="xiangqingjieshao">
						<editor class="list_editor" :value="form.xiangqingjieshao" placeholder="请输入详情介绍" :readonly="!isAdd||disabledForm.xiangqingjieshao?true:false"
							@change="(e)=>editorChange(e,'xiangqingjieshao')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xiangqingjieshao = res.data.data.xiangqingjieshao.replace(reg,'../../../cl2604573/file');
