				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="作者" prop="zuozhe">
							<el-input class="list_inp" v-model="form.zuozhe" placeholder="作者"
								 type="text" 								:readonly="!isAdd||disabledForm.zuozhe?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="资源内容" prop="ziyuanneirong">
							<editor :value="form.ziyuanneirong" placeholder="请输入资源内容" :readonly="!isAdd||disabledForm.ziyuanneirong?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'ziyuanneirong')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.ziyuanneirong = res.data.data.ziyuanneirong?(res.data.data.ziyuanneirong.replace(reg,'../../../cl2604573/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='ziyuanneirong'){
					form.value.ziyuanneirong = row[x];
					disabledForm.value.ziyuanneirong = true;
					continue;
				}
				if(x=='jianshu'){
