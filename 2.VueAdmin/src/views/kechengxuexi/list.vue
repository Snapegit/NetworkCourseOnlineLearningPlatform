...
<template>
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button type="warning" @click="echartClick1" v-if="btnAuth('kechengxuexi','学习时间统计')">学习时间统计</el-button>
				</div>
			</div>
			<br>
			<el-table
		...
		<el-dialog v-model="echartVisible" :title="'学习时间统计'" width="70%">
			<div  id="xuexishijianEchart1" style="width:100%;height:600px;"></div>
...
<script setup>
	...
	const echartClick1 = ()=>{
		...
		nextTick(()=>{
			var xuexishijianEchart1 = echarts.init(document.getElementById("xuexishijianEchart1"),'macarons');
			context?.$http({
