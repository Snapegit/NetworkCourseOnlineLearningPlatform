	...
	:deep(.menu_scrollbar) {
		...
		.menu_view {
			...
			.el-menu-item {
				...
				margin: 0 0 5px;
				color: #fff;
				background: url(http://clfile.zggen.cn/20240102/52d103a1eeca4e5485a717e1c4a954dc.png) no-repeat left center,linear-gradient(0deg, rgba(255,154,2,1) 0%, rgba(254,205,115,1) 55%, rgba(255,220,148,1) 55%, rgba(252,219,151,1) 100%);
				font-weight: 600;
				width: 100%;
				border-color: #ff9c05;
				border-width: 1px;
			...
			.el-menu-item:hover {
				...
				margin: 0 0 5px;
				color: #990033;
				background: url(http://clfile.zggen.cn/20240102/52d103a1eeca4e5485a717e1c4a954dc.png) no-repeat left center,linear-gradient(180deg, rgba(255,154,2,1) 0%, rgba(254,205,115,1) 55%, rgba(255,220,148,1) 55%, rgba(252,219,151,1) 100%);
				border-color: #ff9c05;
				border-width: 1px;
				line-height: 40px;
				border-style: solid;
			...
			.el-menu-item.is-active {
				...
				margin: 0 0 5px;
				color: #990033;
				background: url(http://clfile.zggen.cn/20240102/52d103a1eeca4e5485a717e1c4a954dc.png) no-repeat left center;
				border-color: #ff9c05;
				border-width: 1px;
				line-height: 40px;
				border-style: solid;
